...
$wslWallpaperPath = "\\wsl.localhost\NixOS\home\michaelbrusegard\Projects\infra\wallpapers\twilight-peaks.png"
...
$wslProfilePath = "\\wsl.localhost\NixOS\home\michaelbrusegard\Projects\infra\windows\programs\powershell\profile.ps1"
...
Set-RegistryValue -Path "HKCU:\Environment" -Name "WEZTERM_CONFIG_FILE" -Value "\\wsl.localhost\NixOS\home\michaelbrusegard\Projects\infra\config\wezterm\wezterm.lua" -Type "String"
Write-Host "Setting GLAZEWM_CONFIG_PATH environment variable."
Set-RegistryValue -Path "HKCU:\Environment" -Name "GLAZEWM_CONFIG_PATH" -Value "\\wsl.localhost\NixOS\home\michaelbrusegard\Projects\infra\windows\programs\glazewm\config.yaml" -Type "String"
