  ...
  programs.nvf.settings.vim = {
    ...
    keymaps = [
      ...
      # Octo mappings
      {
        ...
        options = {desc = "List Issues (Octo)";};
      }
      {
        mode = "n";
        key = "<leader>gI";
        action = "<cmd>Octo issue search<CR>";
        options = {desc = "Search Issues (Octo)";};
      }
      {
        mode = "n";
        key = "<leader>gp";
        action = "<cmd>Octo pr list<CR>";
        options = {desc = "List PRs (Octo)";};
      }
      {
        mode = "n";
        key = "<leader>gP";
        action = "<cmd>Octo pr search<CR>";
        options = {desc = "Search PRs (Octo)";};
      }
      {
        mode = "n";
        key = "<leader>gr";
        action = "<cmd>Octo repo list<CR>";
        options = {desc = "List Repos (Octo)";};
      }
      {
        mode = "n";
        key = "<leader>gS";
        action = "<cmd>Octo search<CR>";
        options = {desc = "Search (Octo)";};
      }
      # Kulala mappings
      {
        mode = "n";
      ...
      }
      {
        ...
        lua = true;
        options = {desc = "Download GraphQL schema";};
      }
      {
        mode = "n";
        key = "<leader>Ri";
        ...
        lua = true;
        options = {desc = "Inspect current request";};
      }
      {
        mode = "n";
        key = "<leader>Rn";
        ...
        lua = true;
        options = {desc = "Jump to next request";};
      }
      {
        mode = "n";
        key = "<leader>Rp";
        ...
        lua = true;
        options = {desc = "Jump to previous request";};
      }
      {
        mode = "n";
        key = "<leader>Rq";
      ...
      }
      {
        ...
        lua = true;
        options = {desc = "Replay the last request";};
      }
      {
        mode = "n";
        key = "<leader>Rs";
      ...
      }
      {
        ...
        lua = true;
        options = {desc = "Toggle headers/body";};
      }
    ];
    lazy.plugins = {
      "persistence.nvim" = {
